...
class BulkBookUpload extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
			...
			// e.g a social post, textinput which lets user to enter text, takes persons id as assigned object
				<View style={styles.outerContainer}>
					...
					<View style={styles.textinputContainer}>
						<Button 
							title={'Select BOOK IMAGES From Phone'}
							...
							onPress={async () => {
								...
								try {								
									...
									this.setState(prev => ({...prev, book_image: results}))
									// results.map((res) => {
					...
					<View style={styles.textinputContainer}>
						...
						<Button 
							title={'Select BOOKS EXCEL SHEET From Phone'}
							style={styles.buttonWithoutBG}
							onPress={async () => {
								try {
					...
					<Button 
						...
						onPress={ () => {
							...
							Array.from(this.state.book_image).forEach((file) => {
								formData.append('book_image', {uri: file.uri, name: file.name, type: file.type})
							})
							formData.append('excel_sheet_for_book', {uri: this.state.excel_sheet.uri, name: this.state.excel_sheet.name, type: this.state.excel_sheet.type})

							axios.post(utils.baseUrl + '/uploads/bulk-upload-books', formData)
					...
					<View>
						<Button 
							title={'Press To DELETE ALL BOOKS'}
							style={styles.buttonWithoutBG}
							onPress={ () => {
								axios.get(utils.baseUrl + '/uploads/bulk-delete-books')
								.then(function (response) {
